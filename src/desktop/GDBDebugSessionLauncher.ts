...
export class GDBDebugSessionLauncher {
    /**
    ...
    public static run(debugSession: typeof DebugSession) {
        GDBDebugSessionLauncher.processArgv(process.argv.slice(2));
    ...
    public static processArgv(args: string[]) {
        args.forEach(function (val, _index, _array) {
            ...
            if (configMatch) {
                ...
                if (configMatch[1]) {
                    GDBDebugSessionLauncher.frozenRequestArguments = configJson;
                } else {
                    GDBDebugSessionLauncher.defaultRequestArguments =
                        configJson;
                }
            }
        });
     ...
     */
    public static applyRequestArguments(
        request: 'launch' | 'attach',
        args: LaunchRequestArguments | AttachRequestArguments
    ): ['launch' | 'attach', LaunchRequestArguments | AttachRequestArguments] {
        const frozenRequest =
            GDBDebugSessionLauncher.frozenRequestArguments?.request;
        ...
        return [
            request,
            {
                ...GDBDebugSessionLauncher.defaultRequestArguments,
                ...args,
                ...GDBDebugSessionLauncher.frozenRequestArguments,
            },
        ];
    }
}
