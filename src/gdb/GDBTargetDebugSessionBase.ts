...
import { GDBDebugSessionBase } from './GDBDebugSessionBase';
import { InitializedEvent, OutputEvent } from '@vscode/debugadapter';
...
export class GDBTargetDebugSessionBase extends GDBDebugSessionBase {
    ...
    protected async startGDBAndAttachToTarget(
        ...
        try {
            ...
            await this.afterInitCommands(response, args);
