...
describe('dynamic breakpoint options', async () => {
    describe('with hardware set to false', async () => {
    ...
    describe('with hardware set to true', async () => {
        let dc: CdtDebugClient;
        ...
        it('insert breakpoint as hardware breakpoint', async () => {
            const bpResp = await dc.setBreakpointsRequest({
                source: {
                    name: 'count.c',
                    path: path.join(testProgramsDir, 'count.c'),
    ...
    describe('with throwing error', async () => {
        let dc: CdtDebugClient;
